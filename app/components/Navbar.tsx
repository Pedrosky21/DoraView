    ...
    <>
      <div className="relative flex h-18 px-4 items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          <Link
            href="/"
            className={`absolute z-10 right-20 bg-fern-green border-2 border-black rounded-lg p-2 ${
          ...
          <Link
            href="/"
            className={`absolute z-10 right-20 top-20 bg-fern-green border-2 border-black rounded-lg p-2 ${
              showMenu ? "block" : "hidden"
            }`}
          >
            <svg
          ...
          <Link
            href="/"
            className={`absolute z-10 right-4 top-20 bg-fern-green border-2 border-black rounded-lg p-2 ${
              showMenu ? "block" : "hidden"
            }`}
          >
            <svg
